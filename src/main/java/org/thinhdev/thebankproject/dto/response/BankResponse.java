...
public class BankResponse {
    ...
    public boolean equals(final Object o) {
        ...
        if (this$accountInfo == null ? other$accountInfo != null : !this$accountInfo.equals(other$accountInfo))
            return false;
        return true;
    }
    ...
    public String toString() {
        return "BankResponse(responseCode=" + this.getResponseCode() + ", responseMessage=" + this.getResponseMessage() + ", accountInfo=" + this.getAccountInfo() + ")";
    }
    ...
    public static class BankResponseBuilder {
        ...
        public BankResponse build() {
            return new BankResponse(this.responseCode, this.responseMessage, this.accountInfo);
        }

        public String toString() {
            return "BankResponse.BankResponseBuilder(responseCode=" + this.responseCode + ", responseMessage=" + this.responseMessage + ", accountInfo=" + this.accountInfo + ")";
        }
    }
}
